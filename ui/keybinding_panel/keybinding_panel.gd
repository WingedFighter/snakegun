...
func input_hbox(input_name: StringName) -> TextureButton:
	...
	if event != []:
		...
		if event is InputEventKey:
			...
			var filename_normal = "res://ui/keybinding_panel/icons/keyboard_mouse/keyboard_" + keycode + ".png"
			var filename_pressed = "res://ui/keybinding_panel/icons/keyboard_mouse/keyboard_" + keycode + "_outline.png"
			...
			match event.button_index:
				1:
					filename_normal = "res://ui/keybinding_panel/icons/keyboard_mouse/mouse_left.png"
					filename_pressed = "res://ui/keybinding_panel/icons/keyboard_mouse/mouse_left_outline.png"
				2:
					filename_normal = "res://ui/keybinding_panel/icons/keyboard_mouse/mouse_right.png"
					filename_pressed = "res://ui/keybinding_panel/icons/keyboard_mouse/mouse_right_outline.png"
				4:
					filename_normal = "res://ui/keybinding_panel/icons/keyboard_mouse/mouse_scroll_up.png"
					filename_pressed = "res://ui/keybinding_panel/icons/keyboard_mouse/mouse_left_outline.png"
				5:
					filename_normal = "res://ui/keybinding_panel/icons/keyboard_mouse/mouse_scroll_down.png"
					filename_pressed = "res://ui/keybinding_panel/icons/keyboard_mouse/mouse_left_outline.png"
			button.texture_normal = load(filename_normal)
			button.texture_pressed = load(filename_pressed)
		else:
			button.texture_normal = load("res://ui/keybinding_panel/icons/keyboard_mouse/generic_button_square.png")
			button.texture_pressed = load("res://ui/keybinding_panel/icons/keyboard_mouse/generic_button_square_outline.png")
	else:
		button.texture_normal = load("res://ui/keybinding_panel/icons/keyboard_mouse/generic_button_square.png")
		button.texture_pressed = load("res://ui/keybinding_panel/icons/keyboard_mouse/generic_button_square_outline.png")
	return button
